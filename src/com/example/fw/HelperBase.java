...
public class HelperBase {
	...
	protected final JFrameOperator mainFraim;

	public HelperBase(ApplicationManager applicationManager) {
		this.manager = applicationManager;
		this.mainFraim = manager.getApplication();
	}
	...
	protected String waitMessageDialog(String title, int timeout) {
		...
		while(currentTime < start + timeout){
			JDialog dialog = JDialogOperator.findJDialog(mainFraim.getOwner(), title, false, false);
			if(dialog != null){
